...
const AboutUS = () => {
  return (
    <main className="about-main   laptop:px-5 px-3 laptop:w-full">
      {/* first part of About Section (About Us) */}
      <div className="about-upper-part pt-5 pb-10 flex ">
        <CustomBreadcrumb />
      </div>
      <div className="flex flex-col justify-center items-center laptop:px-20 ">
        ...
        <p className="text-left text-lg mb-4 text-grey font-medium">
          ...
          the market was flooded with hundreds of unsafe applications and review
          websites that weren’t adequately testing them.
        </p>
        <p className="text-left text-lg mb-4 text-grey font-medium">
          Since then, we’ve conducted over 30,000 hours of in-depth VPN testing
          and shared our findings with our readers. We’ve also published
          original research and investigations on issues affecting internet
          privacy, security, and freedom around the world.
        </p>
        ...
        <div className="laptop:flex laptop:w-full laptop:gap-10 tablet:flex tablet:gap-10">
          <div className="tablet:w-2/3">
            ...
            <p className="text-left text-lg mb-4 text-grey font-medium">
              ...
              testing and gather original, hands-on data to evaluate every VPN’s
              performance. Most importantly, our ratings are completely
      ...
      <div className="flex flex-col justify-center items-center laptop:px-20 pt-20 ">
        <div className="laptop:flex laptop:gap-10 laptop:justify-center laptop:items-center">
          ...
          <div className="laptop:w-2/3">
            ...
            <p className="text-left text-lg mb-4 text-grey font-medium">
              The need for a more private, secure, and open Internet has driven
              a quarter of the world’s population to subscribe to a VPN.
            </p>
            <p className="text-left text-lg mb-4 text-grey font-medium">
              ...
              unsafe VPNs on the market, and dozens of VPN review websites that
              <b className="ml-2">haven’t genuinely tested them.</b>
            </p>
            <p className="text-left text-lg mb-4 text-grey font-medium">
              When looking for trustworthy VPN information, we found that many
              VPN review websites are either biased due to their links with VPN
              providers, or lacked experience with VPN services, relying on
            ...
            <p className="text-left text-lg mb-4 text-grey font-medium">
              By sharing our advice, research, and recommendations, our goal is
              to
              <b className="ml-2">make the VPN industry better</b>, so consumers
              worldwide can be in more control of their lives online.
            </p>
          </div>
        </div>
        ...
        <div className="laptop:flex laptop:gap-10 laptop:justify-center laptop:items-center">
          <div className="laptop:flex laptop:flex-col laptop:w-2/3">
            ...
            <p className="text-left text-lg mb-4 text-grey font-medium">
              ...
              service provider. There’s no potential for conflicts of interest,
              and we never bow to pressure from some VPN companies to alter our
              reviews.
            </p>
            <p className="text-left text-lg mb-4 text-grey font-medium">
            ...
            <p className="text-left text-lg mb-4 text-grey font-medium">
              ...
              of our time and resources towards creating objective, independent,
              and unbiased advice for you.
            </p>
