...
{
    title: "The Best VPNs for iPhones & iPads – Stream, Browse and Stay Secure",
    list: [
        "<b>Fastest</b> & <b>Most Secure</b> VPNs for iPhones & iPads (all iOS versions)",
    ...
    data: [
        {
            "attributes": {
                ...
                "details": "CyberGhost: Perfect VPN for iPhone users, easy-to-use iOS app, lightning-fast speeds, and top-tier security to protect your data on the go.",
                "img": "cyberghost.svg",
                "features": [
                    { "value": "User friendly iOS VPN apps for iPhones" },
        ...
        },
        {
            "attributes": {
                ...
                "details": "Total Vpn: Ultra-Fast Speed, perfect for iPhone users who stream or download large files. Military-grade encryption simple installation process.",
                "img": "totalvpn.svg",
                "features": [
        ...
        },
  {
    ...
    reviews: [

        {
            "img": "cyberghost.png",
            "rating": 10,
            "review": "I’ve been using CyberGhost on my iPhone 15 Pro Max for a few months, and it’s amazing. The app is super easy to use and works perfectly with macOS. I can connect with just one click, and it unlocks all my favorite shows on Netflix US. It’s fast, secure, and I love the 45-day money-back guarantee.",
            "author": "Ankit P. (iPhone User)",
            "company_link": {
                "name": "cyberghost.com",
        ...
        },
        {
            "img": "cyberghost.png",
            "rating": 9.5,
            "review": "CyberGhost is perfect for my iPhone 16. I travel a lot, and public Wi-Fi always worried me. With CyberGhost, I feel safe using my phone on any network. Plus, the app looks great and doesn’t slow down my internet.",
        ...
        },
        {
            ...
            "author": "Jack R. (iPhone and Macbook User)",
            "company_link": {
                "name": "surfshark.com",
        ...
        },
        {
            "img": "expressvpn.png",
            "rating": 9.9,
            "review": "I tried many VPNs, but ExpressVPN is the fastest, I used on my iPhone 16 Pro and Mac Air. It keeps my connection secure, and I can access sites and apps that are blocked in my region. It’s a bit pricey, but it’s worth every penny.",
        ...
        },
        {
            "img": "cyberghost.png",
            "rating": 8.6,
            "review": "I use CyberGhost on both my MacBook Air and iPhone 16. It’s great for protecting my privacy and streaming my favorite shows. But Sometimes the server I want is overcrowded, and I have to switch to another, which can be frustrating when I’m in a hurry.",
    ...
    return (
        <section className="bg-[#F9F6EE]">
            ...
            <div className="flex flex-col bg-white px-2 py-[50px] laptop:px-0">
                ...
                Ready to Protect your iPhone? Start with CyberGhost – The #1 choice for iPhone users</h1>
