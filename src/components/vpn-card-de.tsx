        ...
        <div key={idx}>
            ...
            <div className="flex flex-col justify-between px-1 laptop:flex-row laptop:px-3">
                ...
                <div
                  ...
                  <div className="flex w-[80%] flex-col">
                    <div className="relative aspect-[2/1] w-[80%] laptop:w-full">
                      <Image src={`/Assests/test-vpn/vpn/${blog.attributes.img}`} fill alt="express" sizes="(max-width: 1024px) 80vw, 100vw" loading={idx === 0 ? "eager" : "lazy"} />
                    </div>
              ...
              <Link href={`${blog.attributes.link2}`} target="_blank"
                ...
                <div className="flex gap-2">
                  ...
                  <div className="w-full">
                    <div className="flex justify-between pb-1 font-kantumruyPro text-[12px] text-gray-700">
                      <span>Privatsphäre</span><span>{blog.attributes.category_rating.privacy}</span>
                    </div>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="w-full">
                    <div className="flex justify-between pb-1 font-kantumruyPro text-[12px] text-gray-700">
                      <span>Funktionen</span><span>{blog.attributes.category_rating.features}</span>
                    </div>
                ...
                <div className={`flex gap-2 ${idx <= 2 ? null : "hidden"}`}>
                  ...
                  <div className="w-full">
                    <div className="flex justify-between pb-1 font-kantumruyPro text-[12px] text-gray-700">
                      <span>Geschwindigkeit</span><span>{blog.attributes.category_rating.speed}</span>
                    </div>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="w-full">
                    <div className="flex justify-between pb-1 font-kantumruyPro text-[12px] text-gray-700"><span>Benutzerscore</span><span>{blog.attributes.category_rating.userScore}</span></div>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="w-full">
                    <div className="flex justify-between pb-1 font-kantumruyPro text-[12px] text-gray-700"><span>Preiswertigkeit</span><span>{blog.attributes.category_rating.valueForMoney}</span></div>
          ...
          {idx === 0 && (
            <div className="flex items-center justify-center gap-2 px-[15px] pt-4 text-center text-sm laptop:px-0">
              ...
              <b>Profi-Tipp:</b> Der Schutz Deiner Daten im Internet ist wichtiger denn je. Der Einsatz eines VPNs ist nicht nur eine gute Idee, sondern unerlässlich.
              </p>
            </div>
          )}
        </div>
