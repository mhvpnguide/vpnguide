...
const Cards: React.FC<CardProps> = ({ title, imageSrc,link }) => {
    ...
    return (
            <button onClick={handleClick} className="w-fit h-fit tablet:w-full overflow-hidden shadow-lg p-5  flex flex-col bg-white items-center rounded-[30px] hovereff cursor-pointer">
